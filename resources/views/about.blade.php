      ...
      <div class="row align-items-start">
        ...
        <div class="col-md-6 d-none d-md-block  mr-auto">
          <div class="tweet d-flex">
            ...
            <div>
              <p><em>Situs ini adalah situs Resmi Bandung Pride <br> <a href="#">kikipermana020@gmail.com</a></em></p>
            </div>
          </div>
        </div>
        <div class="col-md-4 d-none d-md-block">
          <h3>Hire Me</h3>
          <p>Saya adalah Kiki Permana yang membuat website ini, Terimakasih telah mengunjungi website kami.</a></p>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row mb-5 align-items-end">
          <div class="col-md-6" data-aos="fade-up">
            ...
            <h2>About Me</h2>
            <p class="mb-0">Saya Kiki Permana, Kelas XII Rpl 3, Alamat di Kp. Bojong Cijerah Rw 13 Rt 05.</p>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-7 mb-5 mb-md-0" data-aos="fade-up">
            <p><img src="{{ asset('tampilan/assets/img/images.png')}}" alt="Image" style="width: 400px" height="400px" class="img-fluid"></p>
